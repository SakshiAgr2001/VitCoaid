...
export default function HomePageBody() {
    ...
    const testimonials = [{
            ...
            description: 'Managing my appointments and meeting new clients has never been this easy!',
        ...
        },
        {
            ...
            description: 'The possibility of storing my entire portfolio and manage my bookings all in the same place is priceless to me.',
        ...
        },
        {
            ...
            description: 'After moving to Ireland I had issues finding hairdressers...not anymore thanks to My Hair Done!',
    ...
    return ( <
        ...
        <
        Grid item xs = { 12 }
        className = { classes.faceRecognitionOuterContainer } >
        <
        ...
        Our Augmented Reality Hairstyler uses Machine Learning to read your face landmarks and expressions to help you quickly
        try out different hair styles. <
        br > < /br> <
        br > < /br> <
        Typography variant = 'caption' >
        Use it from a Desktop browser
        ...
        <
        Grid item xs = { 5 }
        className = { classes.faceRecognitionImageContainer } >
        <
        img src = '/facerecognition-circle.png'
        ...
        fullWidth className = { classes.divider }
        />
